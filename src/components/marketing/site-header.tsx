        ...
        {mobileMenuOpen && (
          <>
            <motion.button
              ...
              className="fixed inset-0 z-[5100] bg-black/40 backdrop-blur-sm md:hidden"
            />
            <motion.div
              ...
              className="fixed inset-x-4 top-5 z-[5200] rounded-[2rem] border border-border/60 bg-background/98 p-5 shadow-2xl md:hidden"
            >

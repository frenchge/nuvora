...
export const DEFAULT_MODELS: DefaultModelConfig[] = [
  ...
  {
    _id: "default_anthropic_claude_sonnet_4_7",
    ...
    supports_reasoning: true,
    context_length: 1_000_000,
    context_description: "Newest Sonnet — sharper reasoning, coding, and tool use.",
    sort_order: 46,
  },
  {
  ...
  },
  {
    ...
    supports_reasoning: true,
    context_length: 1_000_000,
    context_description: "Opus 4.7, 1M context, deep Claude reasoning.",
    sort_order: 54,
  },
  {
    _id: "default_anthropic_claude_opus_4_8",
    ...
    supports_reasoning: true,
    context_length: 1_000_000,
    context_description: "Newest, most capable Claude — deepest reasoning, 1M context.",
    sort_order: 55,
  },
  ...
  {
    _id: "default_google_gemini_3_1_flash",
    model_id: "google/gemini-3.1-flash",
    display_name: "Gemini 3.1 Flash",
    provider: "Google",
    category: "standard",
    credit_cost_per_message: 3,
    estimated_cost_per_message_usd: 0.00165,
    free_plan_allowed: true,
    enabled: true,
    supports_streaming: true,
    supports_files: true,
    ...
    supports_tools: true,
    context_length: 1_048_576,
    context_description: "Fast, cheap Gemini 3.1 — multimodal, 1M context.",
    sort_order: 25,
  },
  ...
  {
    _id: "default_deepseek_v3_2",
    model_id: "deepseek/deepseek-v3.2",
    display_name: "DeepSeek V3.2",
    provider: "DeepSeek",
    category: "small",
    credit_cost_per_message: 1,
    estimated_cost_per_message_usd: 0.000705,
    free_plan_allowed: false,
    enabled: true,
    supports_streaming: true,
    supports_files: false,
    ...
    supports_tools: true,
    context_length: 163_840,
    context_description: "Latest DeepSeek — improved reasoning, long context.",
    sort_order: 17,
  },
  ...
  {
    _id: "default_qwen_qwen3_5_max",
    model_id: "qwen/qwen3.5-max",
    display_name: "Qwen 3.5 Max",
    provider: "Alibaba",
    category: "standard",
    credit_cost_per_message: 3,
    estimated_cost_per_message_usd: 0.00273,
    free_plan_allowed: false,
    enabled: true,
    supports_streaming: true,
    supports_files: false,
    supports_tools: true,
    context_length: 262_144,
    context_description: "Qwen 3.5 flagship general model.",
    sort_order: 29,
  },
  {
    _id: "default_qwen_qwen3_7_max",
    ...
    supports_reasoning: true,
    context_length: 262_144,
    context_description: "Newest Qwen flagship — stronger reasoning and tool use.",
    sort_order: 30,
  },
  {
    _id: "default_qwen_qwen3_7_coder",
    model_id: "qwen/qwen3.7-coder",
    display_name: "Qwen 3.7 Coder",
    provider: "Alibaba",
    category: "standard",
    credit_cost_per_message: 3,
    estimated_cost_per_message_usd: 0.002275,
    free_plan_allowed: false,
    enabled: true,
    supports_streaming: true,
    supports_files: false,
    supports_tools: true,
    context_length: 1_000_000,
    context_description: "Code-tuned Qwen 3.7, 1M context.",
    sort_order: 31,
  },
